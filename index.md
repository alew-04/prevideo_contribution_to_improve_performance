...
<img src="static/imgs/graph1.png" alt="Image if bar graph of pre-lecture preference." width="500">
...
<img src="static/imgs/graph2.png" alt="Image of box plot comparing pre-lecture video preference to percieved difficulty." width="500">

Figure 2 displays the comparison of students' opinion on having pre-lecture videos to their opinion on the difficulty of the class. Those who selected 6 or 7 for pre lecture videos also answered higher when asked how difficult the class was for them. Including pre-lecture videos could be a way to decrease the precieved difficulty of the class.

## Figure 3

<img src="static/imgs/graph3.png" alt="Image of box plot comparing pre-lecture video preference to percieved understanding of class." width="500">
